...
try
{
	...
	PreparedStatement pstmt = con.prepareStatement("SELECT * FROM booking where tname= ?");
	pstmt.setString(1,tname);
	ResultSet rs = pstmt.executeQuery();
%>	
	<h3 style="padding:40px;" align=center > ALL Customers </h3><br>
	<table class="table">
  <thead>
    <tr>
...
<% 	
	...
	<tbody>
		...
		<td scope="row"><a href="tech_customercost.jsp?cname=<%=rs.getString(2)%>&test_type=<%=rs.getString(4)%>">click here to Accept</a></td>
